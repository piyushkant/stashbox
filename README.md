...
| [ai](./ai/README.md) | Python + FastAPI service calling a local LLM (Llama via Ollama) | working + wired into backend (Phases 3-5 done) | [ai/README.md](./ai/README.md) |
...
| `createdAt` | Timestamp | |
| `summary` | String? | AI-generated summary, filled by `POST /items/{id}/summarize` |
